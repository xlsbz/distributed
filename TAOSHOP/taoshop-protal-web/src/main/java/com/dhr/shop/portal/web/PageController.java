package com.dhr.shop.portal.web;
...
import com.dhr.shop.portal.pojo.Ad1Node;
...
public class PageController {
	...
	@Autowired
	private ContentIndexListService contentservice;
	...
	public String showIndex(Model model) {
		...
		List<TbContent> contentlist = contentservice.getContentIndexList(categoryId);
