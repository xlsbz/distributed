 //控制层 
app.controller('contentController' ,function($scope,$controller,uploadSerivce,contentService,contentCategoryService){	
	...
	$scope.findAllCate = function(){
		contentCategoryService.findAll().success(
			function(response){
				$scope.cateAllList = response;
			}
		);
	}
	//定义状态
	$scope.cateStatus = ['无效','有效'];
