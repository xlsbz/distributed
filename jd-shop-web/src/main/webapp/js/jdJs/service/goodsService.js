...
app.service('goodsService',function($http){
	...
	//提交审核
	this.updateStatusById = function(id,status){
		return $http.get('../goods/updateStatus.do?ids='+id+'&status='+status);
	}
	//上下架
	this.updateMarketable = function(id,status){
		return $http.get('../goods/updateMarketable.do?ids='+id+'&status='+status);
	}
});
