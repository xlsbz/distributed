...
<body ng-app="jd" ng-controller="itemController" ng-init="num=1;loadSku()">
		...
		<div id="item">
			<div class="crumb-wrap">
				<ul class="sui-breadcrumb">
					...
					<li class="active">${category03}类</li>
				</ul>
			</div>
			<!--product-info-->
				...
				<div class="fl preview-wrap">
					...
					<div class="zoom">
						...
						<div id="preview" class="spec-preview">
							<span class="jqzoom">
								<#if (imageList?size>0)>
									<img jqimg="${imageList[0].url}" src="${imageList[0].url}" width="400" height="400"/>
								</#if>
							</span>
						</div>
						<!--下方的缩略图-->
						...
						<div id="specification" class="summary-wrap clearfix">
							<#list specificationItems as item>
								<dl>
									...
									<#list item.attributeValue as itemOption>
										<dd><a href="javascript:;" class="{{isSelectSpec('${item.attributeName}','${itemOption}')?'selected':''}}" ng-click="selectSpecList('${item.attributeName}','${itemOption}')">
											${itemOption}<span title="点击取消选择">&nbsp;</span></a>
										</dd>
									</#list>
								</dl>
							</#list>
						...
						<div class="summary-wrap">
							<div class="fl title">
								<div class="control-group">
									<div class="controls">
										<input autocomplete="off" type="text" minnum="1" value="{{num}}" class="itxt" />
							...
							<div class="fl">
								<ul class="btn-choose unstyled">
									<li>
										<a target="" class="sui-btn  btn-danger addshopcar" ng-click="addCart()">加入购物车</a>
									</li>
								</ul>
							</div>
						</div>
