...
public class ItemCatController {
	 ...
	 */
	@RequestMapping("/add")
	public Result add(@RequestBody TbItemCat itemCat, String typeId) {
		try {
			itemCat.setTypeId(Long.valueOf(typeId));
	...
	public Result update(@RequestBody TbItemCat itemCat, String typeId) {
		try {
			if (typeId != null) {
				itemCat.setTypeId(Long.valueOf(typeId));
			}
