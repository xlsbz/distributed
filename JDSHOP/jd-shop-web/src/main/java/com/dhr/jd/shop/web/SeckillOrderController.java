...
public class SeckillOrderController {
	...
	public TbSeckillOrder findOne(Long id) {
		TbSeckillOrder findOne = seckillOrderService.findOne(id);
		System.out.println(findOne.getSellerId());
		return findOne;
	}
	...
	public PageResult search(@RequestBody TbSeckillOrder seckillOrder, int page, int rows) {
		...
		PageResult result = seckillOrderService.findPage(seckillOrder, page, rows);
		return result;
	}
